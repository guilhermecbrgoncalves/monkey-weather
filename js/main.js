...
function showPosition(position) {
  ...
  xmlhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      document.getElementById("tempMaxHoje").textContent = "Temperatura Máxima: " + tMaxHoje + " ºC";
      document.getElementById("tempMinHoje").textContent = "Temperatura Minima: " + tMinimaHoje + " ºC";
      document.getElementById("intVentoHoje").textContent = "Intensidade do Vento: " + ventoHoje + "kts";
      document.getElementById("directVentoHoje").textContent = "Direcção do Vento: " + direcVentoHoje;
      document.getElementById("chuvaHoje").textContent = "Probabilidade de Precipitação: " + probChuvaHoje + "%";

      document.getElementById("tempMaxAmanha").textContent = "Temperatura Máxima: " + tMaxAmanha + " ºC";
      document.getElementById("tempMinAmanha").textContent = "Temperatura Minima: " + tMinimaAmanha + " ºC";
      document.getElementById("intVentoAmanha").textContent = "Intensidade do Vento: " + ventoAmanha + "kts";
      document.getElementById("directVentoAmanha").textContent = "Direcção do Vento: " + direcVentoAmanha;
      document.getElementById("chuvaAmanha").textContent = "Probabilidade de Precipitação: " + probChuvaAmanha + "%";

      document.getElementById("tempMaxDepois").textContent = "Temperatura Máxima: " + tMaxDepois + " ºC";
      document.getElementById("tempMinDepois").textContent = "Temperatura Minima: " + tMinimaDepois + " ºC";
      document.getElementById("intVentoDepois").textContent = "Intensidade do Vento: " + ventoDepois + "kts";
      document.getElementById("directVentoDepois").textContent = "Direcção do Vento: " + direcVentoDepois;
      document.getElementById("chuvaDepois").textContent = "Probabilidade de Precipitação: " + probChuvaDepois + "%";
