  ...
  <!--FOOTER-->
  <footer>
    <div class="container-fluid pb-0 mb-0 mt-5 justify-content-center text-light"
      style="background-color: rgb(255, 180, 68)">
          ...
          <div class="row py-5">
            <div class="col-xl-8 col-md-4 col-sm-4 col-12 my-auto mx-auto a">
              ...
              <div class="container mt-5">
                <i class="fab fa-facebook" id="facebook"></i> <i class="fab fa-instagram" id="instagram"></i><i
                  class="fab fa-twitter" id="twitter"></i>
              </div>
            </div>
